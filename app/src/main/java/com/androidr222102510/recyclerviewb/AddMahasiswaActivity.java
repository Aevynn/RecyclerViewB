package com.androidr222102510.recyclerviewb;
...
public class AddMahasiswaActivity extends AppCompatActivity {
    ...
    private EditText _tempatLahirText;
    ...
    private void initSaveButton() {
        ...
        _saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                String tempatLahir = _tempatLahirText.getText().toString();
                ...
                try {
                    ...
                    statusPernikahan = URLEncoder.encode(nim, "utf-8");
                    tanggalLahir = URLEncoder.encode(tempatLahir, "utf-8");
                ...
                ahc.get(url, new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                        Log.d("*rb", new String(responseBody));
